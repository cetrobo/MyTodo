...
angular.module('crud').service('User', function ($http) {
    ...
    return {
        ...
        deleteUser:function(id){
            return $http.delete('https://sails-backoffice.herokuapp.com/api/user/'+id);
        },

        updateUser :function(id,user){
            return $http.put('https://sails-backoffice.herokuapp.com/api/user/'+id,user);
        },
    	signup:  function (data) {
        	return $http.post('https://sails-backoffice.herokuapp.com/api/user',data);       
    	},

    	signin: function(data){
    		return $http.post('https://sails-backoffice.herokuapp.com/api/auth',data);
    	},
